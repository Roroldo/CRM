			...
			<form action="${pageContext.request.contextPath}/product/update.do"
				...
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data" style="padding-top: 8px">
								<input type="radio" class="radio-inline" value="1" name="productStatus" ${product.productStatus == 1 ? "checked" : ""}> 开启
								<input type="radio"  class="radio-inline" value="0" ${product.productStatus == 0 ? "checked" : ""} name="productStatus"> 关闭
						</div>
				...
				<div class="box-tools text-center">
					<button type="submit" class="btn bg-blue-gradient">更新</button>
